...
using FittingsInParkingSpaces.Models;


namespace FittingsInParkingSpaces.ViewModels;

public sealed partial class FittingsInParkingSpacesViewModel : ObservableObject
{
    ...
    public FittingsInParkingSpacesViewModel(UIDocument uiDoc)
    {
        _uiDoc = uiDoc;
